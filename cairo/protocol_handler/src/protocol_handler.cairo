...
mod ProtocolHandler {
    ...
    fn constructor(
        ...
        // Store the Kakarot Core address
    ...
    impl ProtocolHandler of super::IProtocolHandler<ContractState> {
        ...
        fn emergency_execution(ref self: ContractState, call: Call) {
            ...
            // Check if the call is to the Kakarot Core
        ...
        fn upgrade(ref self: ContractState, new_class_hash: ClassHash) {
            ...
            // Call the Kakarot Core upgrade function
            let kakarot_address = self.Kakarot.read();
            let kakarot = IKakarotDispatcher { contract_address: kakarot_address };
        ...
        fn transfer_ownership(ref self: ContractState, new_owner: ContractAddress) {
            ...
            // Call the Kakarot Core transfer_ownership function
            let kakarot_address = self.Kakarot.read();
            let kakarot = IKakarotDispatcher { contract_address: kakarot_address };
        ...
        fn soft_pause(ref self: ContractState) {
            ...
            // Call the Kakarot Core pause function
            let kakarot_address = self.Kakarot.read();
            let kakarot = IKakarotDispatcher { contract_address: kakarot_address };
            kakarot.pause();

            // Emit SoftPause event
            self.emit(SoftPause { protocol_frozen_until: self.ProtocolFrozenUntil.read() });
        }
        ...
        fn hard_pause(ref self: ContractState) {
            ...
            self.emit(HardPause { protocol_frozen_until: self.ProtocolFrozenUntil.read() });
        }
        ...
        fn unpause(ref self: ContractState) {
            ...
            // Unpause the protocol
            // Call the Kakarot Core unpause function
            let kakarot_address = self.Kakarot.read();
            let kakarot = IKakarotDispatcher { contract_address: kakarot_address };
            kakarot.unpause();
