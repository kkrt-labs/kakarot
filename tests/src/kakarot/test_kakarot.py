...
class TestKakarot:
    ...
    class TestDebug:
        ...
        @patch(
            "tests.utils.syscall_handler.SyscallHandler.tx_info",
            new_callable=PropertyMock,
        )
        def test_debug_dump_state(self, mock_caller_address, mock_tx_info, cairo_run):

            # Read the anvil state.json file
            with open("./state.json", "r") as f:
                state_data = json.load(f)
            accounts = state_data.get("accounts", {})
            initial_state = {}
            for address, account in accounts.items():
                account["nonce"] = hex(account["nonce"])
                initial_state[address] = account
            ...
            tx = {
                "type": 2,
                "gas": 1_710_502,
                "maxFeePerGas": 1231113428,
                "maxPriorityFeePerGas": 1000000000,
                "data": "",
                "nonce": 19,
            ...
            # Mock the STARKNET caller address to be the EVM FROM, as
            # the state patches considers evm = starknet address.
            from_addr = 1390849295786071768276380950238675083608645509734
            mock_caller_address.return_value = from_addr

            # Mock the tx_info with the signature of the transaction
            tx_info = OrderedDict(
                {
                    "version": 1,
                    ...
                    "signature_len": None,
                    "signature": [
                        94401936374152104332108911878058515161,
                        78792354955008047215791612265274885427,
                        278594326642500117225870341069219682972,
                        50520163263893802642380254425070121995,
                        0,
                    ],
            ...
            mock_tx_info.return_value = tx_info
