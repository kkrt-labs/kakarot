    ...
    func init_sub_context{
        ...
        if (is_precompile == FALSE) {
            ...
            let sub_ctx = ExecutionContext.init(
                ...
                from_evm_address=calling_ctx.from_evm_address,
    ...
    func initialize_sub_context{
        ...
        if (popped_len != 4) {
            ...
            tempvar sub_ctx = new model.ExecutionContext(
                ...
                gas_price=0,
                starknet_contract_address=starknet_contract_address,
                //TODO: Check if is correct (maybe need to use starknet_address for calling contract)
...
namespace SelfDestructHelper {
    ...
    func finalize{
        ...
        return new model.ExecutionContext(
            ...
            evm_contract_address=ctx.evm_contract_address,
            from_evm_address=ctx.from_evm_address,
