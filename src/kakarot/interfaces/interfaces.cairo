...
namespace IEvmContract {
    func bytecode() -> (bytecode_len: felt, bytecode: felt*, original_bytecode_len: felt) {
    }
    func write_bytecode(bytecode_len: felt, bytecode: felt*, original_bytecode_len: felt) {
    }
