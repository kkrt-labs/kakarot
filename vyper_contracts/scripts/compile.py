...
if __name__ == "__main__":
    source_directory = "vyper_contracts/src"  # The directory where vyper contracts are located
    build_directory = "vyper_contracts/build"       # The directory where compiled files will be saved
