...
build:
	...
	poetry run starknet-compile ./src/kakarot/accounts/eoa/aa/account.cairo --account_contract --output build/kethaa.json --cairo_path ./src --abi build/kethaa_abi.json
