...
build:
	...
	poetry run starknet-compile ./src/kakarot/accounts/registry/blockhash/blockhash_registry.cairo --output build/blockhash_registry.json --cairo_path ./src --abi build/blockhash_registry_abi.json
	poetry run starknet-compile ./src/kakarot/accounts/registry/account/deployer.cairo --output build/account_deployer.json --cairo_path ./src --abi build/account_deployer_abi.json
	poetry run starknet-compile ./src/kakarot/accounts/eoa/account.cairo --output build/account.json --cairo_path ./src --abi build/account_abi.json
...
build-mac:
	...
	starknet-compile ./src/kakarot/accounts/registry/account/deployer.cairo --output build/account_deployer.json --cairo_path ./src --abi build/account_deployer_abi.json
	starknet-compile ./src/kakarot/accounts/eoa/account.cairo --output build/account.json --cairo_path ./src --abi build/account_abi.json
